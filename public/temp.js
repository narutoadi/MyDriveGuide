function initMap() {
      ...
      //  var marker1Array = [];
        ...
        var login=document.getElementById('pac-input3');
        var signup=document.getElementById('pac-input4');

        var symbols = document.getElementById('radio-button-form');
        var symbols2 = document.getElementById('radio-button-form2');

        map.controls[google.maps.ControlPosition.TOP_LEFT].push(origin_input);
        map.controls[google.maps.ControlPosition.TOP_LEFT].push(destination_input);
        map.controls[google.maps.ControlPosition.TOP_RIGHT].push(symbols2);
        map.controls[google.maps.ControlPosition.TOP_RIGHT].push(symbols);
   ...
   //     window.alert("A Short Tour TO The App : Fill the Origin and Destination in top-left boxes, \nYou will Find the most-suitable route displayed on the map. \n Drag the Orange Marker to see landmarks around. \n Happy Browsing :)")
        ...
        function route(origin_place_id, destination_place_id, directionsService, directionsDisplay) {
          ...
          directionsService.route({
			...
			//	alert(totalDistance);
				document.getElementById("rb4").value = "Distance= "+totalDistance/1000 + " KM";
    ...
    //      		window.alert(results.length);
          ...
          function placeExist(x){
          	for(var i =0;i<unique.length;i++)
          	{
          		if(unique[i].place_id == x.place_id){
          			return true;
          		}
          	}
          	return false;
